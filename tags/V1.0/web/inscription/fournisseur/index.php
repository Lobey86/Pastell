...
$page_title = "Inscription sur Pastell";
...
<tr>
	...
	Identifiant (login)
	<span>*</span></label> </th>
	 <td class="w50pc"><input type='text' name='login' value='<?php echo $lastError->getLastInput('login')?>' /></td>
</tr>
<tr>
...
<tr>
	...
	Raison sociale
	<span>*</span></label> </th>
	 <td><input type='text' name='denomination' value='<?php echo $lastError->getLastInput('denomination')?>' /></td>
</tr>
<tr>
	<th><label for='siren'>
	numéro SIREN
	<span>*</span></label> </th>
	 <td><input type='text' name='siren' value='<?php echo $lastError->getLastInput('siren')?>' /></td>
</tr>
