...
class FournisseurSoumissionDonnee extends ChoiceActionExecutor {


	public function display(){
		$this->collectivite_liste  = $this->objectInstancier->CollectiviteFournisseurSQL->getAllFromFournisseurId($this->id_e);
		$this->renderPage("Choix des collectivités", "CollectiviteListSelect");
