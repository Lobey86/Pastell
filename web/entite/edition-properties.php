...
<?php $afficheurFormulaire->affiche($page,"entite/edition-properties-controler.php","document/recuperation-fichier.php?id_d=$id_e","entite/supprimer-fichier.php?id_e=$id_e&page=$page"); ?>
</div>
