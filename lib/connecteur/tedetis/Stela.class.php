...
class Stela extends Tedetis {
	...
	public function __construct(DonneesFormulaire $collectiviteProperties){
		...
		$this->tdt_server_certificate = $collectiviteProperties->getFilePath('tdt_server_certificate');	
		$this->tdt_user_certificat = $collectiviteProperties->getFilePath('tdt_user_certificat');
		$this->tdt_user_certificat_pem = $collectiviteProperties->getFilePath('tdt_user_certificat_pem');
		$this->tdt_user_key_pem = $collectiviteProperties->getFilePath('tdt_user_key_pem');
		$this->tdt_user_certificat_password = $collectiviteProperties->get('tdt_user_certificat_password');
		$this->tdt_user_certificat_and_key_pem = $collectiviteProperties->get('tdt_user_certificat_and_key_pem');
	}
