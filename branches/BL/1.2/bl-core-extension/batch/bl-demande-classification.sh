...
then
    ...
    sudo -H -u www-data /usr/bin/php /var/www/pastell/bl-core-extension/batch/bl-action-connecteur-global.php id_connecteur=tdtbl action=demande-classification
fi
